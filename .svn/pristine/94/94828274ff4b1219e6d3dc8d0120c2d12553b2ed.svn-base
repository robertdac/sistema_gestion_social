...
@endif
    ...
    {!! Form::open(['action'=>'TipoAtencionController@index','method'=>'get']) !!}
...
<div STYLE="margin-bottom: 20px" class="pull-left">
    ...
    {!! link_to('nuevo_tipo_atencion', 'NUEVO TIPO ATENCION', ['class' => 'btn btn-primary']) !!}
...
--}}
                <a title="Editar" href="{{ url("editar_tipo_atencion/$us->id")  }} " ><span class="glyphicon glyphicon-pencil"></span></a> </td>

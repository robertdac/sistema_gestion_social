...
<h2 class="text-center" >TIPOS DE SECRETARIA </h2>
...
@endif
    ...
    {!! Form::open(['action'=>'SecretariaController@index','method'=>'get']) !!}
...
<div STYLE="margin-bottom: 20px" class="pull-left">
    ...
    {!! link_to('nueva_secretaria', 'NUEVA SECRETARIA', ['class' => 'btn btn-primary']) !!}
...
--}}
                <a title="Editar" href="{{ url("editar_secretaria/$us->id")  }} " ><span class="glyphicon glyphicon-pencil"></span></a> </td>

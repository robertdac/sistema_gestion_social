...
<h2 class="text-center" >TIPOS DE RECEPCION </h2>
...
@endif
    ...
    {!! Form::open(['action'=>'RecepcionController@index','method'=>'get']) !!}
...
<div STYLE="margin-bottom: 20px" class="pull-left">
    ...
    {!! link_to('nueva_recepcion', 'NUEVA RECEPCION', ['class' => 'btn btn-primary']) !!}
...
--}}
                <a title="Editar" href="{{ url("editar_recepcion/$us->id")  }} " ><span class="glyphicon glyphicon-pencil"></span></a> </td>

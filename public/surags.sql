...
--
-- Servidor: localhost
-- Tiempo de generación: 05-02-2016 a las 16:02:58
...
(21, 'MISION REVOLUCION ENERGETICA', 1),
...
INSERT INTO `recomendaciones` (`id`, `id_solicitud`, `id_usuarios`, `id_tipo_atencion`, `comentarios`, `monto`) VALUES
(1, 10, 3, 1, 'CUANDO UN IMPRESORA', 8000),
(2, 10, 1, 1, ' DE URGENCIA POR FAVOR', 8000);
...
CREATE TABLE IF NOT EXISTS `solicitudes` (
  ...
  `monto_sugerido` float DEFAULT NULL,
...
INSERT INTO `solicitudes` (`id`, `descripcion`, `observacion`, `monto_solicitado`, `monto_sugerido`, `monto_aprobado`, `id_beneficiario`, `id_solicitante`, `id_tsolicitud`, `id_coordinaciones`, `id_trecepcion`, `id_tatencion`, `id_casa_comercial`, `id_realidad_socieco`, `id_usuarios`, `id_estatus`, `created_at`, `updated_at`) VALUES
(10, 'ES SIMPLEMENTE EL TEXTO DE RELLENO DE LAS IMPRENTAS Y ARCHIVOS DE TEXTO. LOREM IPSUM HA SIDO EL TEXTO DE RELLENO ESTÁNDAR DE LAS', 'INDUSTRIAS DESDE EL AÑO 1500, CUANDO UN IMPRESOR (N. DEL T. PERSONA QUE SE DEDICA A LA IMPRENTA) DESCONOCIDO USÓ UNA GALERÍA DE', 89000, NULL, NULL, 43, 44, 1, 1, 5, NULL, 1, 3, 1, 3, '2016-01-26 20:26:34', '2016-01-27 00:56:34'),
(11, 'ES UN HECHO ESTABLECIDO HACE DEMASIADO TIEMPO QUE UN LECTOR SE DISTRAERÁ CON EL CONTENIDO DEL TEXTO DE UN SITIO MIENTRAS QUE MIRA SU DISEÑO. EL PUNTO DE USAR LOREM IPSUM ES QUE TIENE UNA DISTRIBUCIÓN MÁS O MENOS NORMAL DE LAS LETRAS, AL CONTRARIO DE ', 'AL CONTRARIO DEL PENSAMIENTO POPULAR, EL TEXTO DE LOREM IPSUM NO ES SIMPLEMENTE TEXTO ALEATORIO. TIENE SUS RAICES EN UNA PIEZA CL´SICA DE LA LITERATURA DEL LATIN, QUE DATA DEL AÑO 45 ANTES DE CRISTO, HACIENDO QUE ESTE ADQUIERA MAS DE 2000 AÑOS DE ANT', 25000, 0, NULL, 45, 46, 10, 3, 7, NULL, 13, 2, 1, 1, '2015-12-14 14:42:30', '2015-12-08 21:02:11'),
(12, 'AL CONTRARIO DEL PENSAMIENTO POPULAR, EL TEXTO DE LOREM IPSUM NO ES SIMPLEMENTE TEXTO ALEATORIO. TIENE SUS RAICES EN UNA PIEZA CL´SICA DE LA LITERATURA DEL LATIN, QUE DATA DEL AÑO 45 ANTES DE CRISTO, HACIENDO QUE ESTE ADQUIERA MAS DE 2000 AÑOS DE ANT', 'AL CONTRARIO DEL PENSAMIENTO POPULAR, EL TEXTO DE LOREM IPSUM NO ES SIMPLEMENTE TEXTO ALEATORIO. TIENE SUS RAICES EN UNA PIEZA CL´SICA DE LA LITERATURA DEL LATIN, QUE DATA DEL AÑO 45 ANTES DE CRISTO, HACIENDO QUE ESTE ADQUIERA MAS DE 2000 AÑOS DE ANT', 40000, 0, NULL, 47, 43, 7, 2, 7, NULL, 13, 3, 1, 1, '2015-12-14 14:42:25', '2015-12-08 23:15:32'),
(13, 'PROBLEMAS RESPIRATORIOS', '', 150000, 0, NULL, 48, 49, 10, 3, 6, NULL, 24, 1, 1, 1, '2015-12-14 14:42:23', '2015-12-10 19:25:52');
...
(1, 'V', 19387292, 'ROBERT', 'DE ABREU', '$2y$10$IKWpCAC7.C.qh9rlT4GrD.wNadej6BPRl7HNJhtttQ/wZ6TeK04nu', 'fqe6hvr5DZEqnR6xNUnmYZ7SONekhBB5b0GbM0nD9J0YGVwAVJFuXdXQK8fq', '2016-02-01 15:40:18', '2016-02-01 20:10:18', 'ROBERT.DEABREU@GDC.GOB.VE', 1, 1, 1, 1, 4, 3, 1),
...
(3, 'V', 17456352, 'LUIS', 'FONSI', '$2y$10$8deR77J0XMj1Ll8e/78SDuU/o6e9Ofe80as0.9b4.UXNOCvaKCBZa', NULL, '2016-01-26 01:36:46', '2016-01-26 01:36:46', 'LUIS.FONSI@GDC.GOB.VE', 1, 0, 1, 1, 5, 18, 1);
...
(10, 2, 1, '2015-10-15 23:43:01'),
(10, 3, 2, '2016-01-21 20:53:17'),
(10, 1, 3, '2016-01-27 00:56:34');
...
ALTER TABLE `recomendaciones`
  ADD CONSTRAINT `recomendaciones_ibfk_1` FOREIGN KEY (`id_solicitud`) REFERENCES `solicitudes` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `recomendaciones_ibfk_2` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `recomendaciones_ibfk_3` FOREIGN KEY (`id_tipo_atencion`) REFERENCES `tipo_atencion` (`id`);
...
ALTER TABLE `solicitudes`
  ...
  ADD CONSTRAINT `solicitudes_ibfk_15` FOREIGN KEY (`id_tatencion`) REFERENCES `tipo_atencion` (`id`),
